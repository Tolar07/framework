...
**OLP XDV note (Windows):** invoke as `python -m sports_skills` (the console
script is not on PATH). Source at `external/sports-skills`.

```bash
python -m sports_skills markets get_todays_markets --sport=nba
python -m sports_skills markets search_entity --query="Lakers" --sport=nba
python -m sports_skills markets compare_odds --sport=nba --event_id=401234567
python -m sports_skills markets get_sport_markets --sport=nfl
python -m sports_skills markets get_sport_schedule --sport=nba
python -m sports_skills markets normalize_price --price=0.65 --source=polymarket
python -m sports_skills markets evaluate_market --sport=nba --event_id=401234567
python -m sports_skills markets match_markets --sport=mlb --date=2026-06-06
python -m sports_skills markets get_market_price --venue=kalshi --ticker=KXMENWORLDCUP-26-FR
python -m sports_skills markets get_price_history --venue=kalshi --ticker=KXMENWORLDCUP-26-FR --interval=1d
```
