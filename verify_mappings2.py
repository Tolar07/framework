...
# Also print what IS in the dict for some of these
print("\n\nChecking similar entries in team_map.py:")
search_terms = ['koln', 'ferencvar', 'laci', 'skenderbeu', 'ujpest', 'puskas', 'gyori', 'zalaeger', 'nyiregy']
for term in search_terms:
    for k in SPORTYBET_TEAMS:
        if term.lower() in k.lower():
            print(f"  Found: {k} -> {SPORTYBET_TEAMS[k]}")