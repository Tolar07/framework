#!/usr/bin/env python3
"""Test sidebar navigation by clicking country then league."""
...
async def test_sidebar_nav_fixed(league_name):
    ...
    print(f"Testing fixed sidebar navigation for: '{league_name}'")
...
if __name__ == "__main__":
    ...
    print("=== Testing fixed sidebar navigation ===")
    for league in test_leagues:
        print()
        found = asyncio.run(test_sidebar_nav_fixed(league))
