...
```bash
python -m sports_skills polymarket search_markets --sport=nba --sports_market_types=moneyline
python -m sports_skills polymarket get_todays_events --sport=epl
python -m sports_skills polymarket search_markets --sport=epl --query="Leeds" --sports_market_types=moneyline
python -m sports_skills polymarket get_sports_config
```
