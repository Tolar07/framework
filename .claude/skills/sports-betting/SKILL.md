...
```bash
python -m sports_skills betting convert_odds --odds=-150 --from_format=american
python -m sports_skills betting devig --odds=-150,+130 --format=american
python -m sports_skills betting find_edge --fair_prob=0.58 --market_prob=0.52
python -m sports_skills betting evaluate_bet --book_odds=-150,+130 --market_prob=0.52
python -m sports_skills betting find_arbitrage --market_probs=0.48,0.49
python -m sports_skills betting parlay_analysis --legs=0.58,0.62,0.55 --parlay_odds=600
python -m sports_skills betting line_movement --open_odds=-140 --close_odds=-160
```
