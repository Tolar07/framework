#!/usr/bin/env python3
"""Test sidebar navigation via country and league."""
...
async def test_sidebar_nav(league_name):
    ...
    print(f"Testing sidebar navigation for: '{league_name}'")
    ...
    try:
        async with async_playwright() as p:
            ...
            # Dismiss overlays (copy from rebuild_cache)
            await _dismiss_overlays(page)

            # Click country in sidebar
...
if __name__ == "__main__":
    ...
    print("=== Testing sidebar navigation via country/league ===")
    for league in test_leagues:
        print()
        found = asyncio.run(test_sidebar_nav(league))
