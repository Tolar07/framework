...
class FixtureOdds:
    ...
    # Expanded markets (Architect 2026-08-20): O/U 0.5/3.5, DNB, HT/FT, Correct Score
    # These are populated by SportyBet bridge, Bet365 scraper, and api-football parser
    over35: MarketQuote = field(default_factory=MarketQuote)
    under35: MarketQuote = field(default_factory=MarketQuote)
    over05: MarketQuote = field(default_factory=MarketQuote)
    under05: MarketQuote = field(default_factory=MarketQuote)
    dnb_home: MarketQuote = field(default_factory=MarketQuote)
    dnb_away: MarketQuote = field(default_factory=MarketQuote)
    htft_11: MarketQuote = field(default_factory=MarketQuote)
    htft_1x: MarketQuote = field(default_factory=MarketQuote)
    htft_12: MarketQuote = field(default_factory=MarketQuote)
    htft_x1: MarketQuote = field(default_factory=MarketQuote)
    htft_xx: MarketQuote = field(default_factory=MarketQuote)
    htft_x2: MarketQuote = field(default_factory=MarketQuote)
    htft_21: MarketQuote = field(default_factory=MarketQuote)
    htft_2x: MarketQuote = field(default_factory=MarketQuote)
    htft_22: MarketQuote = field(default_factory=MarketQuote)
    cs_10: MarketQuote = field(default_factory=MarketQuote)
    cs_01: MarketQuote = field(default_factory=MarketQuote)
    cs_11: MarketQuote = field(default_factory=MarketQuote)
    cs_20: MarketQuote = field(default_factory=MarketQuote)
    cs_02: MarketQuote = field(default_factory=MarketQuote)
    cs_21: MarketQuote = field(default_factory=MarketQuote)
    cs_12: MarketQuote = field(default_factory=MarketQuote)
    cs_22: MarketQuote = field(default_factory=MarketQuote)
    cs_00: MarketQuote = field(default_factory=MarketQuote)
    cs_30: MarketQuote = field(default_factory=MarketQuote)
    cs_03: MarketQuote = field(default_factory=MarketQuote)
    cs_31: MarketQuote = field(default_factory=MarketQuote)
    cs_13: MarketQuote = field(default_factory=MarketQuote)
